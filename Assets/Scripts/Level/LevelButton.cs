...
public class LevelButton : MonoBehaviour
{
    ...
    public void DisplayLevelInfo(int levelNumber)
    {
        ...
        bestTime.text = "Best time: " + PlayerPrefs.GetFloat("Level " + levelNumber + "BestTime", 999).ToString("#0.00") + " sec";
        collectedFruits.text = PlayerPrefs.GetInt("Level" + levelNumber + "FruitsCollected").ToString();
        allFruits.text = " / " + PlayerPrefs.GetInt("Level" + levelNumber + "TotalFruits").ToString();
    }
